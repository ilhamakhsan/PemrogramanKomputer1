 ...
 * @author ilham
 */
public class ubahSosmed extends javax.swing.JPanel {
    
    Data sosmed;
    
    public ubahSosmed(Data d) {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_namaAkun, javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE)
...
private void prosesUbah(){
    String id = txt_id.getText();
        ...
        try {
            ...
            String query = "UPDATE `tb_socialmedia` SET `nama_akun` = '"+nama+"', `no_hp` = '"+no_hp+"', `e_mail` = '"+e_mail+"', `password` = '"+password+"' WHERE `tb_socialmedia`.`user_id` = '"+id+"' ;";
